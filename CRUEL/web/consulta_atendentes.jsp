<%-- 
    Document   : consulta_atendentes
    Created on : Nov 21, 2015, 5:38:23 PM
    Author     : Allan
--%>
...
<html>
    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Editar Atendentes</h4>
                    </div>
                    <div class="modal-body">
                        ...
                    </div>
		...
		<!-- MODAL INATIVAR ATENDENTE-->
        <div id="inativarAtendente" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;  </button>
                        <h4 class="modal-title" id="myModalLabel">Inativar Atendente</h4>
                    </div>
                    <div class="modal-body">
                        Tem certeza que deseja desativar o(a) atendente?
                    </div>
                    <div class="modal-footer">
						<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#inativarAtendente"<i class="glyphicon glyphicon-remove"></i>
							<span>Desativar</span>
						</button>
                                    ...
                                    <li class="list-group-item clearfix">
                                        <div class="task-title">
                                            ...
                                            <div class="pull-right hidden-phone">
												<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#editarAtendente"><i class=" glyphicon glyphicon-pencil"></i>
													<span>Editar</span>
												</button>
												<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#inativarAtendente"><i class="glyphicon glyphicon-remove"></i>
													<span>Inativar</span>
