...
public class daoCardapio {
    ...
    private final String stmtGetSemana = "select * from cardapio as CAR where CAR.data between CURRENT_DATE and (CURRENT_DATE+5) order by CAR.data asc, id_refeicao asc";
